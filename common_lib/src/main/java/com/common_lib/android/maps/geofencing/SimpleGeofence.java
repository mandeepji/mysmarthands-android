...
public class SimpleGeofence {
    ...
    public Location getCenterLocation(){
    	...
    	ret.setLatitude(mLatitude);
    	ret.setLongitude(mLongitude);
    ...
    //------------------------------------------------------+
    public static List<LatLng> fencesToLatLngs(List<? extends SimpleGeofence> fences){
    	
    	List<LatLng> ret = new ArrayList<LatLng>();
    	for (SimpleGeofence fence : fences) {
			ret.add(fence.getCenterLatLng());
		}
