 ...
 ******************************************************************************/
package com.common_lib.io.json;
...
public class JsonArray extends JsonValue implements Iterable<JsonValue> {
	...
	/**
	 * replaces the JSON representation of the specified <code>long</code> value
	 * to the array.
	 * 
	 * @param value
	 *            the value to add to the array
	...
	public JsonArray replace(int index,long value) {
		...
		replace(index, valueOf(value));
		return this;
	}

	/**
	 * replaces the JSON representation of the specified <code>float</code>
	 * value to the array.
	 * 
	 * @param value
	 *            the value to add to the array
	...
	/**
	 * replaces the JSON representation of the specified <code>double</code>
	 * value to the array.
	 * 
	 * @param value
	 *            the value to add to the array
	...
	/**
	 * replaces the JSON representation of the specified <code>boolean</code>
	 * value to the array.
	 * 
	 * @param value
	 *            the value to add to the array
	...
	/**
	 * replaces the JSON representation of the specified string to the array.
	 * 
	 * @param value
	 *            the string to add to the array
	 * @return the array itself, to enable method chaining
	...
	/**
	 * replaces the specified JsonValue to the array.
	 * 
	 * @param value
	 *            the JsonValue to add to the array
	 * @return the array itself, to enable method chaining
