...
public class DownloadNotification implements IDownloaderClient {
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            CharSequence tickerText = mLabel + ": " + mCurrentText;
            Notification notification = createNotification(mContext, mContentIntent, mCurrentTitle, iconResource, tickerText, mCurrentText, 0);
            if (ongoingEvent) {
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            Notification notification = createNotification(mContext, mContentIntent, mCurrentTitle, android.R.drawable.stat_sys_download, mLabel, mCurrentText, 0);
            mNotificationManager.notify(NOTIFICATION_ID, notification);
        } else {
            ...
            Notification notification = mCustomNotification.updateNotification(mContext);
            mNotificationManager.notify(NOTIFICATION_ID, notification);
        }
    }
    ...
    private Notification createNotification(Context context, PendingIntent contentIntent, CharSequence title, int icon, CharSequence tickerText, CharSequence text, long when)
    {
